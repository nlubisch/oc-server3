...
const name = 'Administration | opencaching.de'  // TODO: get this variable from setting.ts

module.exports = {
  publicPath: '/admin', //process.env.NODE_ENV === 'production' ? '/vue-typescript-admin-template/' : '/',
  outputDir: '../htdocs/admin',
  lintOnSave: process.env.NODE_ENV === 'development',
  productionSourceMap: false,
  devServer: {
    port: 80,
    public: 'http://docker.team-opencaching.de/admin',
    overlay: {
      warnings: false,
      errors: true
    },
